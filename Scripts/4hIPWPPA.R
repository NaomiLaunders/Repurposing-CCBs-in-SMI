...
####Load trials####
load(paste0(ProjectDir, "/Data/ImputedDataPPA.rdata"))
...
Unadj <- with(data=Weights, coxph(Surv(TimeToMH12, MHBin12) ~ Arm, weights = Weights))
...
write.csv(UnadjResult, "Outputs/TrialIPWPPA.csv")
save(UnadjResult, file=paste0(ProjectDir, "/Data/IPWPPA.rdata"))
